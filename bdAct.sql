...
\restrict KptbEJPaoUSjjwfFGaZJJfndYJI3kjSSE5h6YTQ06lbpWgGdrGE5S80DT2w1ueR
...
--
-- Name: detalles_ingreso detalles_ingreso_id_formacion_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.detalles_ingreso
    ADD CONSTRAINT detalles_ingreso_id_formacion_fkey FOREIGN KEY (id_formacion) REFERENCES public.formaciones(id_formacion);
...
\unrestrict KptbEJPaoUSjjwfFGaZJJfndYJI3kjSSE5h6YTQ06lbpWgGdrGE5S80DT2w1ueR
